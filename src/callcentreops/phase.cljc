(ns callcentreops.phase
  ...
  eligible). Flagging a privacy concern always needs a human to
  actually look at it. `callcentreops.governor`'s own
  `always-escalate-ops` enforces the same invariant independently --
  two layers, not one, agree on this."
  (:require [callcentreops.governor :as governor]))
...
(defn verdict->disposition
  "Map a CallCentreGovernor verdict to a base disposition before
  the phase gate."
  [verdict]
