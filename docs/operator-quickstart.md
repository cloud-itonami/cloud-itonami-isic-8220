# Operator Quickstart — Community Call Centre Operations

Shortest path from clone to a verified local dry-run for **ISIC 8220** (`cloud-itonami-isic-8220`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8220.git
cd cloud-itonami-isic-8220
```
...
- Blueprint governor key: `call-centre-governor`
- Likely source path: `src/**/call-centre-governor.cljc`
